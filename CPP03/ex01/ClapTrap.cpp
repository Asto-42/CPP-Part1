...
/*   Updated: 2024/02/20 15:15:18 by jquil            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << "The ClapTrap " << this->Name << " is attack but he is already dead" << std::endl;
		return ;
	}
	std::cout << "The ClapTrap " << this->Name << " is attack	HP = " << this->hit_points << std::endl;
	...
	if (this->hit_points == 0)
		...
		std::cout << "The ClapTrap " << this->Name << " is now " << this->hit_points << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "The ClapTrap " << this->Name << " start to repair	HP = " << this->hit_points << std::endl;
	if (this->hit_points < 10)
		this->hit_points = this->hit_points + amount;
	if (this->hit_points > 10)
		this->hit_points = 10;
	std::cout << "Repaire is finish - ClapTrap is now " << this->hit_points << std::endl;
}
